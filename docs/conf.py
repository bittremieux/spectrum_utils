...
latex_documents = [
    (master_doc, 'spectrum_utils.tex', 'spectrum\\_utils Documentation',
     'Wout Bittremieux', 'manual'),
]
...
man_pages = [
    (master_doc, 'spectrum_utils', 'spectrum_utils Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'spectrum_utils', 'spectrum_utils Documentation',
     author, 'spectrum_utils', 'One line description of project.',
     'Miscellaneous'),
]
